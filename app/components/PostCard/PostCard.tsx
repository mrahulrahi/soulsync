...
import { FaEllipsis, FaRegImage, FaVideo } from "react-icons/fa6";
            ...
            <div className="card shadow-sm rounded border-0 bg-white">
                ...
                <div className="card-header d-flex justify-content-between align-items-center bg-white">
                    <div className="d-flex align-items-center">
                        <a href="#" className="nbt-profile-img-box rounded-circle overflow-hidden d-flex align-items-center justify-content-center">
